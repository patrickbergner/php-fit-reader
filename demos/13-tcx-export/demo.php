...
demo_title('13', 'TCX export (Garmin Training Center) — raw, normalized, and as a string');
...
// continuous 1 Hz timeline. Add a GPS-derived speed and it flows into ax:Speed.
